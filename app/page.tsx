  ...
  return (
    <div className = "relative">
      ...
      <div className="w-full text-left px-6 lg:px-32 mb-16">
         ...
         <div className='w-full h-fit grid lg:grid-rows-1 grid-cols-1 md:grid-cols-3 lg:grid-cols-6 gap-8 my-8'>
          <div className="col-span-full md:col-span-full w-full h-full relative rounded-lg pb-8 p-9 bg-gradient-to-l from-[#22291F] to-[#020302] overflow-hidden transition">
            ...
            <div className="relative z-0 *:ml-auto">
              ...
              <Image alt="Parthenon Event" src="https://hc-cdn.hel1.your-objectstorage.com/s/v3/9799d308000f849f_image.png" className="max-h-[15vh] w-auto" width={1121} height={390} />
        ...
        {/* Athena Award Card */}
        <div className='w-full h-fit grid grid-cols-1 gap-8 my-8'>
          <div className="col-span-full w-full h-full relative rounded-lg pb-8 p-9 bg-gradient-to-r from-[#903A42] to-[#8D2423] overflow-hidden transition">
            ...
            <div className="relative z-0 *:ml-auto h-full flex flex-col">
              ...
              <Image alt="Athena Award" src="https://hc-cdn.hel1.your-objectstorage.com/s/v3/6ea8e84acae378a03d5b5e788a780a853aae4d21_outlinedlogoaltcropped.svg" className="max-h-[15vh] w-auto" width={1121} height={390} />
        ...
        <div className='w-full h-fit grid lg:grid-rows-1 grid-cols-1 md:grid-cols-3 lg:grid-cols-6 gap-8 my-8'>
          <div className="col-span-full md:col-span-full w-full h-full relative rounded-lg pb-8 p-9 bg-gradient-to-l from-[#150122] via-[#150122] to-[#2651A6] overflow-hidden transition">
            <div className="relative z-0">
              ...
              <Image alt="Ascend Event" src="https://hc-cdn.hel1.your-objectstorage.com/s/v3/885cf1045da83ea1_image.png" className="max-h-[15vh] w-auto" width={1121} height={390} />
        ...
        <div id="bento" className="w-full grid lg:grid-rows-1 grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-8 my-8">
          ...
          <Card cardType="tinted" image="https://hc-cdn.hel1.your-objectstorage.com/s/v3/696924ad1ae25f58_image.png" tintColor="#2E0E0C" href="/team" title="Team" description="Meet the team behind Athena" className="md:col-span-2 lg:col-span-3 self-stretch" />
          ...
          <Card cardType="tinted" image="https://hc-cdn.hel1.your-objectstorage.com/s/v3/75219c1a7afb6cd6_image.png " tintColor="#223B26" href="https://daysofservice.hackclub.com" title="Days of Service" description="Looking for the old site? Click here." className="md:col-span-1 lg:col-span-2 self-stretch" /> 
