    ...
    <div className = "relative">
      ...
      <div className="w-full text-left px-6 lg:px-32 mb-16">
         ...
         <div className='w-full h-fit grid lg:grid-rows-1 grid-cols-1 md:grid-cols-3 lg:grid-cols-6 gap-8 my-8'>
          <div className="col-span-full md:col-span-full w-full h-full relative rounded-lg pb-8 p-9 bg-gradient-to-l from-[#22291F] to-[#020302] overflow-hidden transition">
            ...
            <div className="relative z-0 *:ml-auto">
              ...
              <Image alt="Parthenon Event" src="https://cdn.hackclub.com/rescue?url=https://hc-cdn.hel1.your-objectstorage.com/s/v3/9799d308000f849f_image.png" className="max-h-[15vh] w-auto" width={1121} height={390} />
          ...
          <div className="col-span-full md:col-span-3 w-full h-full relative rounded-lg pb-8 p-9 bg-gradient-to-r from-[#903A42] to-[#8D2423] overflow-hidden transition">
            ...
            <Image alt="" src="https://cdn.hackclub.com/rescue?url=https://hc-cdn.hel1.your-objectstorage.com/s/v3/315b4d8271ec9804a39feb90d0c8c0da22be2411_image.png" className="h-[100%] w-auto absolute -bottom-[2vh] -left-[20vh] opacity-25 md:opacity-75" height={800} width={800}></Image>
          </div>
          ...
          <div className="col-span-full md:col-span-3 w-full h-full relative rounded-lg pb-8 p-9 bg-gradient-to-l from-[#150122] via-[#150122] to-[#2651A6] overflow-hidden transition">
            <div className="relative z-0 flex flex-col h-full">
              ...
              <Image alt="Ascend Event" src="https://cdn.hackclub.com/rescue?url=https://cloud-rnls34zc7-hack-club-bot.vercel.app/0reduced-whitespace-ascend-logo.png" className="max-h-[15vh] w-max" width={1121} height={390} />
        ...
        <div id="bento" className="w-full grid lg:grid-rows-1 grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-8 my-8">
          ...
          <Card cardType="tinted" image="https://cdn.hackclub.com/rescue?url=https://hc-cdn.hel1.your-objectstorage.com/s/v3/696924ad1ae25f58_image.png" tintColor="#2E0E0C" href="/team" title="Team" description="Meet the team behind Athena" className="md:col-span-2 lg:col-span-3 self-stretch" />
          {/*<Card cardType="tinted" image="https://cdn.hackclub.com/rescue?url=https://cloud-lz7wipd7a-hack-club-bot.vercel.app/2horizon-coding-min.png" tintColor="#223B26" href="#" title="Start Hacking" description="Teenager? Stay tuned!" className="md:col-span-1 lg:col-span-2 self-stretch" /> */}
          <Card cardType="tinted" image="https://cdn.hackclub.com/rescue?url=https://hc-cdn.hel1.your-objectstorage.com/s/v3/75219c1a7afb6cd6_image.png " tintColor="#223B26" href="https://daysofservice.hackclub.com" title="Days of Service" description="Looking for the old site? Click here." className="md:col-span-1 lg:col-span-2 self-stretch" /> 
