...
export default async function ProjectsPage() {
  ...
  return (
    <div className="container  bg-[#8c2e37]">
      ...
      <div className="flex flex-col items-center justify-center mb-3 px-6 lg:px-32 relative">
        <h1 className="text-7xl font-bold text-center text-white playfair-display">
      ...
      <div className="px-6 lg:px-32 py-6 grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-6  bg-[url(/bg.svg)] shadow-lg w-full border-t-2 border-white/10">
