...
export const CALENDAR_EVENTS: CalendarEvent[] = [
  {
    ...
    description:
      "see the [Athena Award](https://award.athena.hackclub.com) for more details",
    tags: ["athena-award"],
  },
  {
    ...
    hostedBy: [
      ...
      },
      {
        username: "@phthallo",
        avatarUrl:
          "https://ca.slack-edge.com/T0266FRGM-U078J6H1XL3-724a93fb0c6f-512",
      },
    ],
    tags: ["athena-award"],
  },
    ...
    hostedBy: [
      {
        username: "@acon",
        avatarUrl:
          "https://ca.slack-edge.com/T0266FRGM-U04KEK4TS72-7a65eae6cb6d-512",
      },
    ],
  ...
  },
  {
    ...
    description:
      "Learn how to use Git, Github, VScode and Codespaces. To see the slides click [here](https://docs.google.com/presentation/d/1Bvlc6PLaPOWEu_K9H2rqyYPyxSbU_-iYkh6T2AW9Kf4/edit)",
    hostedBy: [
      {
        username: "@reem",
        avatarUrl:
          "https://ca.slack-edge.com/T0266FRGM-U06U80G86H1-a7cc92358101-512",
      },
      {
        username: "@Meghana",
        avatarUrl:
  ...
  },
  {
    ...
    description:
      "learn more at [express.athena.hackclub.com](https://express.athena.hackclub.com)!",
    hostedBy: [
      {
        username: "@chxsi",
        avatarUrl:
          "https://ca.slack-edge.com/T0266FRGM-U077C11T3A8-fbdfa7b256a4-512",
      },
    ],
    recording:
      "https://mega.nz/file/TBVVTQDb#L91Z7uVN8jTshs30ulKtHEHAz8D1pdrK6HZgHJpk8e4",
    artifactsAvailable: true,
  ...
  },
  {
    ...
    description:
      "Meghana will be hosting a hackpad workshop/speedrun, where she'll make a hackpad in 2 hours and answer all of your questions. You can follow along, or just sit and vibe to learn",
    hostedBy: [
      {
        username: "@Meghana",
        avatarUrl:
...

  {
    ...
    name: "Flourish",
    description:
      "📍 Philadelphia's Athena Event! Learn more at [flourish.hackclub.com](https://flourish.hackclub.com)!",
    tags: ["athena-event"],
  },

  {
    ...
    description:
      "learn how to build a Pathfinder, an eFidget and controller pad",
    hostedBy: [
      {
        username: "@lou",
        avatarUrl:
    ...
    hostedBy: [
      {
        username: "@estella",
        avatarUrl:
          "https://ca.slack-edge.com/T0266FRGM-U06UYA4AH6F-a85235815241-512",
      },
    ],
    recording:
      "https://hackclub.slack.com/archives/C0931T5SEH4/p1751299015727739",
    tags: ["game-dev"],
  },
  {
    date: new Date("06-30-2025"),
    ...
    hostedBy: [
      {
        username: "@Angad",
        avatarUrl:
          "https://ca.slack-edge.com/T0266FRGM-U075RTSLDQ8-42c3f01d5932-512",
      },
    ],
    rsvpLink: "",
    tags: ["hardware", "workshop"],
  ...
  },
  {
    ...
    name: "JPEG in Ottawa",
    description:
      "Ottawa's first all-girls hackathon! July 5–6 at Carleton University.",
  ...
  },
  {
    ...
    description:
      "Learn how to build a simple desktop app using Electron for the Rewind YSWS",
    hostedBy: [
      {
        username: "@Lou",
        avatarUrl:
  ...
  },
  {
    ...
    description:
      "Learn how to make a cookie cutter using OnShape and get cookies!",
    hostedBy: [
      {
        username: "@Kate",
        avatarUrl:
          "https://ca.slack-edge.com/T0266FRGM-U07PXU0657B-19a567a11837-512",
      },
    ],
  ...
  },
  {
    ...
    description:
      "See [aurora.hackclub.com](https://aurora.hackclub.com) for more details",
    tags: ["athena-event"],
  },
  {
    ...
    description:
      "Plunge into CAD! Learn how to make custom, stamp-style cookie cutters and get them shipped!",
    hostedBy: [
      {
        username: "@Kate",
        avatarUrl:
    ...
    hostedBy: [
      {
        username: "@celeste",
        avatarUrl:
          "https://ca.slack-edge.com/T0266FRGM-U06TV3F4HEU-ee45e446ed7e-512",
      },
    ],
  ...
  },
  {
    ...
    description:
      "Wanna make cool mobile apps? Hannah will show you exactly how in this workshop!",
    hostedBy: [
      {
        username: "@hannah oss",
        avatarUrl:
          "https://ca.slack-edge.com/T0266FRGM-U08QKM7KPQD-g772c316ea02-512",
      },
    ],
  ...
  },
  {
    ...
    name: "Athenathon!",
    description:
      "Join your fellow acolytes for a marathon coding sprint that'll get you one step closer to the Athena Award!",
    ...
    hostedBy: [
      ...
      },
      {
        username: "@elia",
        avatarUrl:
          "https://ca.slack-edge.com/T0266FRGM-U06HPP9GZ3R-c28081aa1f5d-192",
      },
    ],
  },
  {
    date: new Date("08-30-2025"),
    name: "Movie Night - Oceans 8!",
    description:
      "We're watching Oceans 8 - a movie with an all-female team of thieves and specialists for a heist during the Met Gala.",
    tags: ["other", "athena-event"],
  },
...

  {
    ...
    name: "Parthenon",
    description:
      "Completed the Athena Award? We'll see you in New York City! 🗽",
    tags: ["athena-award", "athena-event"],
  },
];
